...
export default function Industries() {   
    return (     
      <div className="min-h-screen bg-gray-50 py-10 px-4 bg-white border-t-4 border-orange-500 rounded-xl p-4  items-center shadow-sm hover:shadow-md hover:bg-gray-200 transition">       
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6 max-w-6xl mx-auto">         
          {languages.map((lang, index) => (           
            <a             
              ...
              className="bg-white border-t-4  rounded-xl p-4 flex flex-col items-center shadow-sm hover:shadow-md hover:bg-orange-400 transition"           
            >             
